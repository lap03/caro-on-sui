...
export default function HomePage() {
  // Kept as a no-op read to preserve the original hook-call order (in case we
  // grow account-specific home-page variations later).
  useCurrentAccount();
    ...
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 1.5rem' }}>
      ...
      >
        ...
        >
          ...
          <span className="animate-float" style={{ animationDelay: '0.5s', color: 'var(--color-player-o)' }}>
            ○
          </span>
...
function StepCard({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '200px' }}>
      ...
      <h4 style={{ fontFamily: 'var(--font-display)', fontWeight: 600, marginBottom: '0.35rem' }}>
        {title}
      </h4>
      <p
        style={{
